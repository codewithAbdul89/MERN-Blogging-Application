...
import { accessTokenOptions, refreshTokenOptions } from "../Services/cookie.options.js"
import oauthLoginHelper from "../Helper/oauthLoginHelper.js";
import { deleteFile, uploadFile } from '../Services/file.service.js'
import { sendResetPasswordEmail, sendVerificationEmail, sendWelcomeEmail } from "../services/email/email.service.js";
...
export const signup = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new ApiResponse(201, "User Created Successfully", { user: createdUser, accessToken }))
});
...
export const login = asyncHandler(async (req, res) => {
    ...
    const matchedUser = user.toObject()
...
export const verifyEmail = asyncHandler(async (req, res) => {
    ...
    if (matchedToken.expiresAt < new Date()) {
        await EmailToken.findByIdAndDelete(
            matchedToken._id
        );
...
export const refreshToken = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, "Token refresh successfully", { accessToken: newAccessToken }))
