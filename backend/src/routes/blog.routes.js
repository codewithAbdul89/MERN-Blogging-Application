...
router.get("/search", getSearchedBlog);

router.get("/my-blogs", protectedRoute, getMyBlogs);

router.get("/edit/:blogId", protectedRoute, getBlogForEdit);

router.get("/liked-blogs", protectedRoute, getLikedBlogs);

router.get("/bookmarks", protectedRoute, getBookmarkedBlogs);
...
router.patch("/:blogId/publish", protectedRoute, publishBlog);

router.patch("/:blogId/unpublish", protectedRoute, unpublishBlog);
...
//Blog pinnig
router.patch("/:blogId/pin", protectedRoute, pinBlog);

//Toogle Bookmarks

router.patch("/:blogId/bookmark", protectedRoute, toggleBookmark);
