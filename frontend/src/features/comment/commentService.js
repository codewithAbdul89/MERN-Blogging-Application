...
export const getComments = async ({ blogId, page = 1, limit = 6 }) => {
...
export const getReplies = async ({ parentCommentId, page = 1, limit = 4 }) => {
  const response = await api.get(`/comment/${parentCommentId}/replies`, {
    params: {
      page,
      limit,
    },
